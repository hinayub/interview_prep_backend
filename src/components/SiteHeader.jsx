  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-5 py-4 sm:px-8">
        <Link
          to="/"
          className="group flex items-center gap-2.5 rounded-lg text-ink"
        ...
        {isAuthenticated ? (
          <Link to="/app" className="btn-ink px-4 py-2 text-sm">
            Open Cortex
          ...
          <div className="flex items-center gap-1.5 sm:gap-3">
            ...
            <Link to="/create-account" className="btn-ink px-4 py-2 text-sm">
              Get started
            </Link>
          </div>
        )}
